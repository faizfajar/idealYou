...
<div class="max-w-5xl mx-auto px-4 pb-12">
    ...
    <div class="space-y-10">
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden flex flex-col transition-all hover:shadow-2xl">
            <div class="p-8">
                <div class="flex items-center mb-8">
                    <div class="bg-green-100 p-4 rounded-2xl mr-5 shadow-sm">
                        <svg class="w-8 h-8 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 15.546c-.523 0-1.046.151-1.5.454a2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.701 2.701 0 00-1.5-.454M9 16v2m3-3v3m3-3v3M9 9h.01M12 12h.01M15 9h.01M21 12c0 1.657-3.134 3-7 3s-7-1.343-7-3 3.134-3 7-3 7 1.343 7 3z"></path></svg>
                    </div>
                    <div>
                        <h2 class="text-2xl font-black text-gray-800 tracking-tight">Rekomendasi Pola Makan</h2>
                        <p class="text-sm text-green-600 font-semibold tracking-wider uppercase mt-1">Nutrisi & Diet Sehat</p>
                    </div>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    <img src="https://images.unsplash.com/photo-1490645935967-10de6ba17061?q=80&w=600" class="w-full h-56 object-cover rounded-2xl shadow-sm hover:opacity-90 transition" alt="Healthy Meal">
                    <img src="https://images.unsplash.com/photo-1512621776951-a57141f2eefd?q=80&w=600" class="w-full h-56 object-cover rounded-2xl shadow-sm hover:opacity-90 transition" alt="Vegetables">
                </div>
                    ...
                    <div class="bg-green-50/50 p-8 rounded-2xl border border-green-100">
                        <ul class="space-y-5">
                            ...
                            <li class="flex items-start text-gray-700">
                                <div class="bg-green-500 rounded-full p-1 mr-4 mt-1 flex-shrink-0">
                                ...
                                <span class="text-lg leading-relaxed font-medium">{{ $diet }}</span>
                            </li>
                            @endforeach
                        </ul>
                    </div>
            ...
            <button onclick="toggleCard('detail-makan', this)" class="w-full py-6 bg-gray-50 hover:bg-green-50 text-gray-500 hover:text-green-600 font-black transition-all border-t border-gray-100 tracking-[0.2em] text-xs">
                Lihat Detail
            </button>
        </div>
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden flex flex-col transition-all hover:shadow-2xl">
            <div class="p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    <img src="https://images.unsplash.com/photo-1517836357463-d25dfeac3438?q=80&w=600" class="w-full h-56 object-cover rounded-2xl shadow-sm" alt="Workout">
                    <img src="https://images.unsplash.com/photo-1538805060514-97d9cc17730c?q=80&w=600" class="w-full h-56 object-cover rounded-2xl shadow-sm" alt="Exercise">
                </div>
                ...
                <div id="detail-olahraga" class="hidden animate-fade-in-up">
                    <div class="bg-blue-50/50 p-8 rounded-2xl border border-blue-100">
                        <ul class="space-y-5">
                            ...
                            <li class="flex items-start text-gray-700">
                                <div class="bg-blue-500 rounded-full p-1 mr-4 mt-1 flex-shrink-0">
                                    <svg class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                                </div>
                                <span class="text-lg leading-relaxed font-medium">{{ $exercise }}</span>
                            </li>
                            @endforeach
                        </ul>
                    </div>
            ...
            <button onclick="toggleCard('detail-olahraga', this)" class="w-full py-6 bg-gray-50 hover:bg-blue-50 text-gray-500 hover:text-blue-600 font-black transition-all border-t border-gray-100 tracking-[0.2em] text-xs">
                Lihat Detail
            </button>
        </div>
